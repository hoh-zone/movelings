...
module intro::intro_tests {
    ...
    fun test_create_string_table() {
        ...
        // 测试创建成功
        intro::destroy_string_table(table);
    }
    ...
    fun test_add_entry() {
        ...
        let _ = intro::remove_entry(&mut table, 1);
        intro::destroy_table(table);
    }
    ...
    fun test_add_multiple_entries() {
        ...
        let _ = intro::remove_entry(&mut table, 1);
        let _ = intro::remove_entry(&mut table, 2);
        let _ = intro::remove_entry(&mut table, 3);
        intro::destroy_table(table);
    }
    ...
    fun test_get_value() {
        ...
        assert!(*value == 50, 7);
        let _ = intro::remove_entry(&mut table, 5);
        intro::destroy_table(table);
    }
    ...
    fun test_get_value_mut() {
        ...
        let _ = intro::remove_entry(&mut table, 10);
        intro::destroy_table(table);
    }
    ...
    fun test_add_string_entry() {
        ...
        let _ = sui::table::remove(&mut table, 1);
        intro::destroy_string_table(table);
    }
