...
module intro::intro_tests {
    ...
    fun test_add_u64() {
        ...
        let _ = intro::remove_u64(&mut bag);
        intro::destroy_bag(bag);
    }
    ...
    fun test_add_string() {
        ...
        let _ = intro::remove_string(&mut bag);
        intro::destroy_bag(bag);
    }
    ...
    fun test_add_item() {
        ...
        intro::remove_item_and_destroy(&mut bag);
        intro::destroy_bag(bag);
    }
    ...
    fun test_get_item() {
        ...
        assert!(intro::item_id(item_ref) == 1, 33);
        assert!(*intro::item_name(item_ref) == b"test", 34);
        intro::remove_item_and_destroy(&mut bag);
        intro::destroy_bag(bag);
    }
    ...
    fun test_update_item_name() {
        ...
        let item_ref = intro::get_item(&bag);
        assert!(*intro::item_name(item_ref) == b"new", 35);
        intro::remove_item_and_destroy(&mut bag);
        intro::destroy_bag(bag);
    }
}
